...
guake -n $(pwd)
guake -r "Server" -e "source env/bin/activate"
guake -e "python manage.py runserver 1111"

guake -n $(pwd)
guake -r "Terminal" -e "source env/bin/activate"

guake -n $(pwd)
guake -r "Shell" -e "source env/bin/activate"
guake -e "python manage.py shell"

guake -n $(pwd)
guake -r "Email" -e "source env/bin/activate"
guake -e "python -m smtpd -n -c DebuggingServer localhost:1025"

guake -n $(pwd)
guake -r "Celery" -e "source env/bin/activate"
